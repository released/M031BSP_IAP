...
#define FMC_CUSTOM_APROM_BASE          		(0x00004000UL)
...
void Read_BS(void)
{
	...
	printf("boot loader >>>>> APP_01 in KEIL linker option R/O base :0x00004000\r\n");
	printf("boot loader >>>>> APP_02 in KEIL linker option R/O base :0x00004000\r\n");
...
void Manual_update_FW(void)
{
	...
	printf("boot loader : [1] , update APP_01 to 0x4000 ,  (APP_01 store in 0x10000)\r\n");
	printf("boot loader : [2] , update APP_02 to 0x4000 , (APP_02 store in 0x12000)\r\n");
...
void UART0_Init(void)
{
	...
	printf("\r\nboot loader : CLK_GetCPUFreq : %8d\r\n",CLK_GetCPUFreq());
	printf("boot loader : CLK_GetHXTFreq : %8d\r\n",CLK_GetHXTFreq());
	printf("boot loader : CLK_GetLXTFreq : %8d\r\n",CLK_GetLXTFreq());	
	printf("boot loader : CLK_GetPCLK0Freq : %8d\r\n",CLK_GetPCLK0Freq());
	printf("boot loader : CLK_GetPCLK1Freq : %8d\r\n",CLK_GetPCLK1Freq());	
	#endif	
